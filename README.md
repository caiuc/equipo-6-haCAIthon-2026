...
| **Interfaz gráfica y Benchmark (FUNCIONAL)** | `interfaz_grafica_benchmark/` | Python + PySide6 (Qt) + Benchmark (FUNCIONAL) | App de escritorio que dispara el benchmark y muestra resultados |
